...
const InstallationDetailsEnercal = () => {
  ...
  const handleUpdateDate = async () => {
    try {
      const updatedData = {
        ...
        demandeEnercal: {
          ...installation.demandeEnercal,
          enercalDate: newDate, // Mettre à jour la date
        },
      };
      ...
      {isLoading ? (
        ...
        <>
          ...
          <div className="d-flex justify-content-between align-items-center">
            <h1>Installation : {installation.refference} Demande Enercal</h1>
            ...
            <Row>
              ...
              >
                <Row>
                  ...
                  <Col>
                    {installation.demandeEnercal.enercalDate ? (
                      <>
                        <p>
                          {new Date(
                            installation.demandeEnercal.enercalDate
              ...
              >
                ...
                <Col>
                {installation.demandeEnercal.dateReponse ? (
                  <p>
                    {new Date(
                      installation.demandeEnercal.dateReponse
                    ).toLocaleDateString()}
          ...
          <section className="margin-2">
            ...
            <div className="remarque-box">
              <p>{installation.demandeEnercal.remarque}</p>
            </div>
          </section>
...
export default InstallationDetailsEnercal;
