...
const InstallationDetailsConformite = () => {
  ...
  const handleUpdateDate = async () => {
    try {
      const updatedData = {
        ...
        conformite: {
          ...installation.conformite,
          conformiteDate: newDate, // Mettre à jour la date
        },
      };
  ...
  const handleUpdateVisitDate = async () => {
    try {
      const updatedData = {
        ...
        conformite: {
          ...installation.conformite,
          visiteDate: newVisitDate, // Mettre à jour la date de la visite
        },
      };
      ...
      {isLoading ? (
        ...
        <>
          ...
          <div className="d-flex justify-content-between align-items-center">
            <h1>Installation : {installation.refference} Demande Conformité</h1>
            ...
            <Row>
              ...
              >
                <Row>
                  ...
                  <Col>
                    {installation.conformite.conformiteDate ? (
                      <>
                        <p>
                          {new Date(
                            installation.conformite.conformiteDate
          ...
          <section className="margin-2">
            ...
            <div className="remarque-box">
              <p>{installation.conformite.remarque}</p>
            </div>
          </section>
...
export default InstallationDetailsConformite;
